...
def read_preprocessed_df(file_path):
    ...
    mydf[['BL2VD_yrs', 'Age', 'Education', 'TDI']] = get_normalization(mydf[['BL2VD_yrs', 'Age', 'Education', 'TDI']])
    return mydf
...
my_files = ['/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_0to5yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_0to3yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_3to5yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_5to6yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_6to7yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_7to8yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_8to9yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_9to10yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_10to11yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_11to12yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/VD_Analysis/Partition_NA80/PriorVD_12to15yrs.csv',
...
ref_dict = pd.read_csv('/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Results/VD_Analysis/S111_Results.csv')
