...
def read_preprocessed_df(file_path):
    ...
    mydf[['BL2AD_yrs', 'Age', 'Education', 'TDI']] = get_normalization(mydf[['BL2AD_yrs', 'Age', 'Education', 'TDI']])
    return mydf
...
my_files = ['/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_0to5yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_0to3yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_3to5yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_5to6yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_6to7yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_7to8yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_8to9yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_9to10yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_10to11yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_11to12yrs.csv',
            '/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Data/AD_Analysis/Partition_NA80/PriorAD_12to15yrs.csv',
...
for file in my_files:
    ...
    for f in my_f:
        try:
            tmp_df = mydf[[f] + ['case_control', 'BL2AD_yrs', 'Age', 'Gender', 'Education', 'TDI', 'Ethnicity']]
...
all_result_df = pd.read_csv(outpath + 'S1_Results.csv')
ref_dict = pd.read_csv('/Volumes/JasonWork/Projects/UKB_DM_Trajectories/Results/AD_Analysis/S111_Results.csv')
ref_dict = ref_dict[['FieldID_full', 'p_0to5yrs_fdr_x', 'Category_y', 'Sub.category', 'Clinical.Assessments', 'Figure2_dm', 'Figure3_dm', 'Figure3_Field', 'years']]
all_result_df = pd.merge(ref_dict, all_result_df, how = 'left', on = ['FieldID_full'])
all_result_df.to_csv(outpath + 'S1_Results1.csv', index=False)
